document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('minlength')) {
        ...
        if (value.length < min) {
          showFieldError(field, 'Please enter at least ' + min + ' characters.');
          isValid = false;
          return;
        }
      }
      ...
      if (field.hasAttribute('maxlength')) {
        ...
        if (value.length > max) {
          showFieldError(field, 'Please enter no more than ' + max + ' characters.');
          isValid = false;
          return;
        }
      }
  ...
  function showFieldError(field, message) {
    ...
    field.addEventListener('input', function onInput() {
      ...
      const err = parent ? parent.querySelector('.form-error') : null;
      if (err) err.remove();
      ...
      const scrollObserver = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            ...
            const delay = el.getAttribute('data-delay') || el.getAttribute('data-animate-delay');
  ...
  function addScrollAnimationStyles() {
    ...
    const translateX = isRTL ? '20px' : '-20px';
    ...
    style.textContent = [
      ...
      '}',
      '[data-animate="slide-left"].fade-in-ready {',
      '  transform: translateX(' + translateX + ');',
      '}',
      '[data-animate="slide-left"].fade-in-ready.fade-in-visible {',
      '  transform: translateX(0);',
      '}',
      '[data-animate="slide-right"].fade-in-ready {',
      '  transform: translateX(' + (isRTL ? '-20px' : '20px') + ');',
      '}',
      '[data-animate="slide-right"].fade-in-ready.fade-in-visible {',
      '  transform: translateX(0);',
      '}',
      '[data-animate="zoom"].fade-in-ready {',
      '  transform: scale(0.92);',
      '}',
      '[data-animate="zoom"].fade-in-ready.fade-in-visible {',
      '  transform: scale(1);',
      '}'
    ].join('\n');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מתוקים בעיניים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '45de579a-655b-44ad-bcc9-17431ad45917',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '45de579a-655b-44ad-bcc9-17431ad45917';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '45de579a-655b-44ad-bcc9-17431ad45917';
